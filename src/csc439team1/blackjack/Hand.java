...
public class Hand extends Deck
{
    ...
    public static void main(String[] args)
    {
        ...
        //Shoe shoe = new Shoe(numberOfDecks);         //creates a Shoe object named shoe
        Deck deck = new Deck();         //creates a Deck object named deck
        Hand playerHand = new Hand();       //creates a Hand object named playerHand
        Hand houseHand = new Hand();        //creates a Hand object named houseHand
        ...
        playerHand.addCard(deck.deal());  //add one card to the player's deck (initial card)
        //houseHand.addCard(deck.deal());
        //houseHand.addCard(deck.deal());
        ...
        do
        {
            playerHand.addCard(deck.deal()); //add one card to the player's deck (after first initial card or each time the player hit)
            if (isBusted())
            {
                System.out.println("Your cards are: " + playerHand.cards.toString());
