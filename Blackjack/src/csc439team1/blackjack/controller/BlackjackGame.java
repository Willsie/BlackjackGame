...
public class BlackjackGame extends Application {
    ...
    private final Shoe shoe = new Shoe(1);
    ...
    Image imageback = new Image("file:resources/image/BlackjackTable.png");
